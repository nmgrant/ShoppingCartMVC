...
namespace Ch24ShoppingCartMVC.Models {
   public class CartModel {
      ...
      private ProductViewModel GetSelectedProduct(string id) {   //Create an OrderModel object called order
      ...
      public void AddToCart(CartViewModel model) {
         if (model.AddedProduct.ProductID != null) {
            ...
            var inCart = GetCartFromDataStore().Where(s => s.ProductID.Equals(productID)).FirstOrDefault();
            if (inCart == null)
